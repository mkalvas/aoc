...
- `100` would _not be valid_; no two of the previous 25 numbers sum to `100`.
- `50` would also _not be valid_; although `25` appears in the previous 25 numbers, the two numbers in the pair must be different.
...
- `65` would _not be valid_, as no two of the available numbers sum to it.
