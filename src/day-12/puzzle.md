...
- `R90` would cause the ship to turn right by 90 degrees and face south; it remains at _east 17, north 3._
...
- `N3` moves the waypoint 3 units north to _10 units east and 4 units north_ of the ship. The ship remains at _east 100, north 10_.
...
- `R90` rotates the waypoint around the ship clockwise 90 degrees, moving it to _4 units east and 10 units south_ of the ship. The ship remains at _east 170, north 38_.
